            ...
            <div class="table-responsive">
                <table class="table card-table table-vcenter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span class="avatar avatar-md rounded-circle shadow-sm" style="background-image: url(<?php echo $foto_final; ?>)"></span>
                            </td>
                            <td>
                                <div class="font-weight-medium text-dark">
                                    <?php echo $row['nombre']." ".$row['apellido']; ?>
                                    <?php if($row['id_titular']): ?>
                                        <span class="badge bg-purple-lt ms-1">Familiar</span>
                                    <?php endif; ?>
                                </div>
                            ...
                            <td>
                                <span class="badge bg-purple-lt">
                                    <?php echo htmlspecialchars($row['nombre_entrenador'] ?? 'Sin asignar'); ?>
                                </span>
                            </td>
                            ...
                            <td>
                                <div class="btn-list flex-nowrap">
                                    <?php $es_moroso = ($vence < $hoy); ?>
                                    
                                    <a href="renovar_socio.php?id=<?php echo $row['id_socio']; ?>" 
                                       class="btn <?php echo $es_moroso ? 'btn-danger' : 'btn-white'; ?> btn-icon" 
                                       onclick="return confirm('<?php echo $es_moroso ? '¡AVISO: Socio vencido!' : ''; ?> ¿Confirmar renovación?')" title="Renovación">
                                    ...
                                    <a href="eliminar_socio.php?id=<?php echo $row['id_socio']; ?>" class="btn btn-white btn-icon" onclick="return confirm('¿Segura?');" title="Eliminar">
