...
<div class="page-wrapper">
    <div class="container-xl mt-4">
        <div class="row align-items-center mb-4">
            <div class="col"><h2 class="page-title">Gestión de Socios</h2></div>
            ...
            <div class="table-responsive">
                <table class="table card-table table-vcenter">
                    ...
                    <tbody>
                        ...
                        $res = $conexion->query("SELECT s.*, m.nombre as plan FROM socios s JOIN membresias m ON s.id_membresia = m.id_membresia ORDER BY s.id_socio DESC");
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="font-weight-medium text-dark"><?php echo $row['nombre']." ".$row['apellido']; ?></div>
                                <div class="text-muted small"><?php echo $row['telefono']; ?></div>
                                <div class="text-muted small"><?php echo $row['correo']; ?></div> </td>
                            ...
                            <td>
                                ...
                                <small class="text-muted"><?php echo ($row['estado'] != 'activo' && $vence >= $hoy) ? 'Inactivo Manual' : 'Fecha de pago'; ?></small>
                            </td>
                            <td>
